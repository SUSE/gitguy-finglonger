...
// PullRequest definition of the Github PullRequest payload
...
// ReviewCommentPayload to create a Review Comment
...
// SubmitReviewPayload to create actions for approving Reviews
type SubmitReviewPayload struct {
	Body  string `json:"body,omitempty"`
	Event string `json:"event,omitempty"`
}

// PullRequestReview definition of the Github PullRequestReview payload
